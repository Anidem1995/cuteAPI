...
namespace cuteAPI.Controllers
{
    ...
    public class WalletsController : ControllerBase
    {
        ...
        public WalletsController(cute_homeContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Wallet>> PostWallet(Wallet wallet)
        {
            ...
            return CreatedAtAction("GetWallet", new { id = wallet.IdWallet }, wallet);
        }
        ...
        {
            return _context.Wallets.Any(e => e.IdWallet == id);
        }
    }
}
